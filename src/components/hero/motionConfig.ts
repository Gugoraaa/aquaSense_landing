...
export const statsSettleSeconds = 1.12;
export const statsSettleMilliseconds = statsSettleSeconds * 1000;
...
export function statsSyncTransition(delay = 0) {
  return {
    delay,
    duration: Math.max(0.34, statsSettleSeconds - delay),
    ease: heroEase,
  };
}
